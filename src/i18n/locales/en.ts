...
export const en: Record<keyof typeof pt, string> = {
  ...
  'chart.noTop': 'No transactions yet.',

  'city.perDay': 'Cities per day',
  'city.placeholder': 'city',
  'city.list': 'Trip cities',
  'city.addCity': 'Add city',
  'city.removeCity': 'Remove',
  'city.blockCityLabel': 'City',
  'city.blockRangeLabel': 'Date range',
  'city.addBlock': 'Add period',
  'city.noBlocks': 'No periods set yet.',
  'city.daysN': 'day(s)',
  'city.unassignedN': 'day(s) without a city',
  'city.removeBlockConfirm': 'Remove this period? Those days will be left without a city.',
  'city.removeUsedWarning': 'Removing it will also clear those days. Continue?',
  ...
  'tab.cities': 'Cities',
  'tab.cats': 'Categories',
  'sec.cumulative': 'Cumulative spend',
  'sec.byDay': 'By day',
  ...
  'col.count': 'Count',
  'col.entry': 'transaction',
  'col.entries': 'transactions',
