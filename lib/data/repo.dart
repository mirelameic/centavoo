...
Future<void> moveTripUp(AppDatabase db, String tripId) => _swapTripOrder(db, tripId, -1);

Future<void> moveTripDown(AppDatabase db, String tripId) => _swapTripOrder(db, tripId, 1);

Future<void> _swapTripOrder(AppDatabase db, String tripId, int direction) async {
  ...
  if (index == -1 || targetIndex < 0 || targetIndex >= trips.length) return;
