...
void main() {
  ...
  testWidgets('deleting the trip removes it and navigates back to the trips list', (tester) async {
    ...
    await tester.pumpWidget(MaterialApp.router(locale: const Locale('pt', 'BR'), localizationsDelegates: AppLocalizations.localizationsDelegates, supportedLocales: AppLocalizations.supportedLocales, routerConfig: router));
    await tester.pumpAndSettle();
    await tester.tap(find.text('open'));
    await tester.pumpAndSettle();
