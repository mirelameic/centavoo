    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          if (hasSplit) ...[
            sectionHeader(context, 'Você dividiu × sua parte'),
            LayoutBuilder(
              builder: (context, constraints) {
                ...
                return Wrap(
                  ...
                  children: [
                    SizedBox(
                      width: cardWidth,
                      child: _SplitCard(label: 'VALOR INTEGRAL', value: money(stats.split.integral, currency: currency)),
                    ),
                    SizedBox(
                      width: cardWidth,
                      child: _SplitCard(label: 'SUA PARTE', value: money(stats.split.share, currency: currency)),
                    ),
                    SizedBox(
                      width: cardWidth,
                      child: _SplitCard(
