...
class _CategoryFormState extends State<CategoryForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: Text(widget.editing != null ? 'Editar categoria' : 'Nova categoria'),
      content: SizedBox(
        width: 340,
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text('Cor', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 13, color: hintColor)),
              ...
              const SizedBox(height: 16),
              Text('Ícone', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 13, color: hintColor)),
              const SizedBox(height: 6),
              Wrap(
                spacing: 6,
                runSpacing: 6,
