      ...
      children: [
                  ...
                  child: Wrap(
                    ...
                    children: [
                      if (isIof)
                        ...
                        _metaBadge(context, 'Reembolso', _tealColor)
                      else
                      ...
                      if (showPeriod) ...[
                        Text('·', style: TextStyle(color: hintColor.withValues(alpha: 0.5))),
                        Text(
                          tx.period == periodBefore ? 'Antes' : 'Durante',
        ...
        Column(
          ...
          children: [
            ...
            if (tx.splitCount > 1)
              Text('integral ${money(tx.amount, currency: currency)}', style: TextStyle(fontSize: 12, color: hintColor)),
          ],
        ),
