...
class _TransactionFormState extends State<TransactionForm> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text(widget.editing != null ? 'Editar transação' : 'Nova transação'),
      content: SizedBox(
        width: 360,
          ...
          child: Column(
            ...
            children: [
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'Data', hintText: '—'),
              ),
                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      decoration: InputDecoration(labelText: 'Valor', prefixText: widget.trip.currency == 'BRL' ? 'R\$ ' : ''),
                      onChanged: (_) => setState(() {}),
                    ),
                  ),
                  ...
                  Expanded(
                    child: TextField(
                      ...
                      decoration: const InputDecoration(labelText: 'Dividir por'),
                    ),
                  ),
                ],
              ),
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  DropdownMenuItem(value: kindExpense, child: Text('Gasto')),
                  DropdownMenuItem(value: kindRefund, child: Text('Reembolso')),
                ],
              ...
              if (_kind == kindRefund)
                CheckboxListTile(
                  ...
                  title: const Text('Reembolso de IOF'),
                  value: _isIof,
              ...
              if (_kind == kindExpense) ...[
                ...
                DropdownButtonFormField<String?>(
                  ...
                  decoration: const InputDecoration(labelText: 'Categoria', hintText: '—'),
                  items: [
      ...
      actions: [
        ...
        ElevatedButton(onPressed: _valid ? _save : null, child: const Text('Salvar')),
      ],
    );
  }
}
